...
from learning.gail_old.utils.utils import *
from learning.gail_old.utils.zfilter import ZFilter
from learning.gail_old.model import Actor, Critic, Discriminator
from learning.gail_old.train_model import train_actor_critic, train_discrim
...
def main():
    ...
    #Load UR expert data
    expert_demo = np.load("/home/peter/OneDrive/Skrivebord/Uni stuff/Masters/masters_code/mj_sim/learning/airl_UR/expert_demo/Expert_data_constant_joint/all_state_actions.npy")
    ...
    for iter in range(args.max_iter_num):
        ...
        while steps < args.total_sample_size: 
            ...
            for _ in range(10000): 
                ...
                old_policy = log_prob_density(torch.Tensor(action), mu, std)

                print("actions: ", action)
                print("mu: ", mu)
                print("std: ", std)
                print("old_policy_0: ", old_policy)
                print("length of actions: ", len(action))
                print("length of probability: ", old_policy.size())
                input()
        ...
        if train_discrim_flag and False:
