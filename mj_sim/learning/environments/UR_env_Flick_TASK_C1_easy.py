...
class URSim_SKRL_env(MujocoEnv):
    ...
    def __init__(self, args, name, render_mode="human"):
        ...
        path_expert_data_1 = os.path.abspath("learning/airl_UR/expert_demo/C1_easy_25-04-28_11-54-27URSim_SKRL_env_PPO/expert_memory_modified_no_time_no_performance_metric.pkl")
    ...
    def step(
        ...
        #a = self.expert_memory_1[self.step_number+250*self.episode_count][1]
