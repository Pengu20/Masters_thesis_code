...
from utils.mj import get_mj_data, get_mj_model, attach, detach,  get_joint_names, get_joint_q, get_joint_dq, get_joint_ddq, get_joint_torque, body_name2id, set_joint_q, get_body_pose, get_body_vel
...
class URSim_SKRL_env(MujocoEnv):
    ...
    def __init__(self, args, name, render_mode="human"):
        ...
        # Load start state:learning/config_files/C1_start_state/backup_C1_easy/qpos_start_state.pkl
        qpos_dir = os.path.abspath("learning/config_files/C1_start_state/backup_C1_easy/qpos_start_state.pkl")
        qvel_dir = os.path.abspath("learning/config_files/C1_start_state/backup_C1_easy/qvel_start_state.pkl")
        ...
        # path_expert_data_1 = os.path.abspath("learning/airl_UR/C1_small_25-04-28_11-54-27URSim_SKRL_env_PPO/expert_memory_modified_no_time.pkl")
